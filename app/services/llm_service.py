...
class LLMService:
    ...
    async def detect_bias(self, text: str) -> Dict:
        ...
        #                         "explanation": "why this is biased and not job-relevant with proper justification"
                    ...
                    {{
                        ...
                        "issues": [
                            {{
                                ...
                                "end_index": 10,
                                "severity": "low|medium|high",
                                "explanation": "why this is biased and not job-relevant in simpler terms with proper justification"
