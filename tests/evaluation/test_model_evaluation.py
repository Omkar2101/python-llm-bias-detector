...
class BiasModelEvaluator:
    ...
    def save_results(self, results: Dict, filename: str = None):
        ...
        with open(filepath, 'w') as f:
            json.dump(results, f, indent=2, default=str)  # Added default=str to handle any non-serializable objects
    ...
    async def main():
        ...
        for result in results['individual_results'][:3]:  # Show first 3 cases
            if 'error' not in result:
                ...
                if isinstance(result['actual_scores']['bias_score'], (int, float)):
                    ...
                    print(f"Expected vs Actual Bias Score: {result['expected_scores']['bias_score']:.2f} vs {result['actual_scores']['bias_score']}")
                    print(f"Expected vs Actual Inclusivity Score: {result['expected_scores']['inclusivity_score']:.2f} vs {result['actual_scores']['inclusivity_score']}")
